...
const messages = {
  en: {
    ...
    copiedLabel: "Install command copied",
      ...
      guideEyebrow: "DSH Usage Guide",
      guideTitle: "Usage Guide",
      guideLoading: "Loading guide…",
      guideLoadFailed: "Failed to load guide",
      guideMoreTitle: "More articles",
      guideComingSoon: "More articles coming soon…",
      guideBack: "Back to articles",
  ...
  zh: {
    ...
    copiedLabel: "安装命令已复制",
      ...
      guideEyebrow: "DSH 使用指南",
      guideTitle: "使用指南",
      guideLoading: "正在加载指南…",
      guideLoadFailed: "指南加载失败",
      guideMoreTitle: "更多文章",
      guideComingSoon: "更多文章敬请期待",
      guideBack: "返回文章列表",
